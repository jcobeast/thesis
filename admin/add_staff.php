      ...
      <div class="content">
         <div class="container-fluid">
            ...
            <div class="alert alert-success" role="alert">
               ...
               <strong>Staff is added sucessfully</strong>
            </div>
            <?php }
            ?>
            <?php
            ...
            <div class="alert alert-warning" role="alert">
               <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               <strong>Staff is not added at this time try again!</strong>
            </div>
            <?php }
            ?>
            <a href="list_of_staffs.php" class="btn btn-primary pull-right"><i class="fa fa-navicon" aria-hidden="true"></i>&nbspList of Staffs</a>
            <br>
            <br>
            <br>
            <div class="panel panel-info">
               ...
               <div class="panel-body">
                  <form class="form-horizontal" role="form" method="post" action="save_staff_info.php" enctype="multipart/form-data">   
                     <div class="col-md-6">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">  
                     <div class="button-group pull-right">
                        <button type="submit" class="btn btn-success" name="submit" ><i class="fa fa-check" aria-hidden="true"></i>&nbspAdd Staff Info</button>
                        &nbsp
